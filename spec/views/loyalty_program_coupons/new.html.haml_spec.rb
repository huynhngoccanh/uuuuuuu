...
RSpec.describe "loyalty_program_coupons/new", type: :view do
  before(:each) do
    assign(:loyalty_program_coupon, LoyaltyProgramCoupon.new(
      :loyalty_program => nil,
  ...
  it "renders new loyalty_program_coupon form" do
    render

    assert_select "form[action=?][method=?]", loyalty_program_coupons_path, "post" do
