...
RSpec.describe "loyalty_program_offers/new", type: :view do
  before(:each) do
    assign(:loyalty_program_offer, LoyaltyProgramOffer.new(
      :loyalty_program => nil,
      :name => "MyString",
  ...
  it "renders new loyalty_program_offer form" do
    render

    assert_select "form[action=?][method=?]", loyalty_program_offers_path, "post" do
